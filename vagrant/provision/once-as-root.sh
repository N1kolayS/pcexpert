...
apt-get install -y php7.4-curl php7.4-cli php7.4-intl php7.4-mysqlnd php7.4-zip php7.4-gd php7.4-fpm php7.4-mbstring php7.4-xml unzip nginx mysql-server-5.7 php7.4-xdebug
...
mysql -uroot <<< "CREATE DATABASE yii2basic character set UTF8 collate utf8_unicode_ci"
mysql -uroot <<< "CREATE DATABASE yii2basic_test character set UTF8 collate utf8_unicode_ci"
echo "Done!"
